  ...
  return async (request, ctx) => {
    ...
    try {
      ...
      if (status === 500) {
        ...
        // Awaited: this function is about to return, and on a
        // serverless host that means it is about to stop existing.
        // An unawaited send is queued into a process that ends first.
        await logError(`[${route}] unhandled failure`, err);
      }
      res = Response.json(
