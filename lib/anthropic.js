  ...
  try {
    ...
    if (b && typeof b === 'object' && !Array.isArray(b)) {
      ...
      const caps = {
        ...
        region: 80, postcode: 20, country: 40, phone: 40,
      };
